...
const mineModel = require("./js/getMine.js")
...
function showAdd(res) {
    ...
    var fileContent = fs.readFileSync(AddPath);
    res.writeHead(200, {
        "Content-Type" : "text/html; charset=utf-8"
    });
    res.end(fileContent);
...
function showLM(res) {
    var LMPath =  path.join(__dirname, "/list.html");
    var fileContent = fs.readFileSync(LMPath);
    res.writeHead(200, {
        "Content-Type" : "text/html; charset=utf-8"
    });
    res.end(fileContent);
...
function getChap(res) {
    var chap = JSON.stringify(chapterList)
    res.writeHead(200, {
...
function showDetail(res) {
    ...
    var fileContent = fs.readFileSync(chapterpath);
        res.writeHead(200, {
            "Content-Type": "text/html; charset=utf-8"
        });
        res.end(fileContent);
